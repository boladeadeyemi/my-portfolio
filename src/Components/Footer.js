  ...
  return (
    <div className="bg-white h-40 text-center justify-center py-24" id="footer">
      <div className="md:mx-auto mx-[35%] my-auto w-[15%] flex flex-row justify-between mb-4">
        ...
        <a href="https://www.facebook.com/Boleegin" target="_blank">
          <FacebookOutlined />
        </a>
        <a href="https://twitter.com/boladeadeyemi" target="_blank">
          <Twitter />
        </a>
        <a
      ...
      <div className="font-Poppins font-light md:text-xs text-xs text-[#999999]">
        <Copyright fontSize="small" /> 2023 Bolade, all rights reserved
      </div>
    </div>
  );
}
