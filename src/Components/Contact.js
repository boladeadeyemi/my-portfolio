...
function Contact() {
  ...
  return (
    <div className='w-full bg-[#F9F9F9] py-16 px-4' id='contactMe'>
          ...
          <form onSubmit={handleSubmit} method="POST" className='max-w-[1240px] mx-auto grid md:grid-cols-2 md:grid-rows-2'>
            ...
            <div className='px-1 pb-5 ml-3 py-4'>
             <textarea placeholder='Message' className='border-b-2 mx-autox w-[95%] py-8 pl-2'
              type='text'
              name='message'/>

            </div>
            <div className='px-1 pb-5 ml-3 py-4'>
             <button className='py-2 text-center bg-[#49bc56] w-[40%] md:text-sm sm:text-[0.9em] text-[0.7em] text-white font-Poppins ml-2'
